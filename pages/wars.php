...
<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiacom/images/global/content/table-shadow-rm.gif);">
										<div class="TableContentContainer">
											<table class="TableContent" width="100%" style="border:1px solid #faf0d7;background-color;#faf0d7;">
												<tbody>
                        <tr bgcolor="#D4C0A1">
                                <td align="center"><b>To invite a guild to war use your own guild page.</b></td>
                        </tr>
											</tbody></table>
										</div>
									</div>
