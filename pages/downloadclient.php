															...
															<table class="TableContent" width="100%">
																<tr>
																	...
																	<center><h1>Official '.$config['server']['serverName'].' Client</h1></center>
																			...
																			<tr>
																			<td valign="top">
																					<a href="https://drive.google.com/open?id=1igJAWD2vH8adjfqkmyoB4DHQJjdOp7RJ" target="_blank" type="application/octet-stream" target="_top">Thornia Launcher (auto-update)<br/>Windows Client</a>
																				</td>
																				<td valign="top">
																					<a href="https://drive.google.com/open?id=19KSTYEpb-Smn-4Mj9AIPH1RWLScD1wxM" target="_blank" type="application/octet-stream" target="_top">Thornia Client (non-updatable)<br/>Windows Client</a>
																				</td>
																			</tr>
																			<tr>
																				<td colspan="2" >[<span class="HelpLink" style="width: 18px; height: 18px;" ><a href="/common/tibiaclientrequirements.php" target="_blank" ><span class="HelperDivIndicator" onMouseOver="ActivateHelperDiv($(this), \'More information:\', \'<p><b>Thornia Launcher (auto-update):</b><ul><li>Updateable launcher</li><li>Better interface</li><li>Faster update</li></ul><b>Thornia Client (non-updatable):</b><ul><li>Manual update</li><li>Outdated interface</li><li>Slow and difficult update</li><ul></ul>\', \'\');" onMouseOut="$(\'#HelperDivContainer\').hide();" >more information</span></a></span>]</td>
																			</tr>
																		</table>
																	</td>
																</tr>
												...
												<td style="vertical-align:top">
													...
													<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif)">
														...
														<tbody><tr>
															...
															<td>
															<br>
															<center><h1>Supported Thornia Bots</h1></center>
															<br><table style="width:100%;text-align:center">
																	<tbody><tr>
																		<td><a type="application/octet-stream" target="_top"><img style="width:100px;height:100px;border:0px" src="images/thornia/xenobot_icon.png"></a></td><td><a type="application/octet-stream" target="_top"><img style="width:100px;height:100px;border:0px" src="images/thornia/magebot_icon.png"><br>
																			</a></td>

																	</tr>
																	<tr>

																	<td valign="top"><a href="" target="_blank" type="application/octet-stream">Download Xenobot</a>																	
																		</td><td valign="top"><a href="https://drive.google.com/open?id=1lu6AFhLDfmSxQcQ-NDca4cdNQmuNpriX" target="_blank" type="application/octet-stream">Download Magebot</a>
																		<br>
																		</td>
																	</tr>
																</tbody></table>
