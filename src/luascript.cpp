...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnumIn("configKeys", ConfigManager::WALKTHROUGH_LEVEL)
	registerEnumIn("configKeys", ConfigManager::INBOX_MAX_ITEMS)
	registerEnumIn("configKeys", ConfigManager::INBOX_MAX_WEIGHT)
